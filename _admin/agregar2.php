                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                               ...
                               include("../Connections/conexion.php");
                                ...
                                $fab=$_POST["fab"];
                                $origen=$_POST["origen"];
                                $insert_prod=mysqli_query($con,"INSERT into productos (p_nombre,p_descripcion,p_foto,precio,p_almacen,p_fabricante,p_origen) values('$nombre','$desc','$foto',$precio,$stock,'$fab','$origen')") or die(mysqli_error($con));
                               ?>                            
                             <h1>ya se armo bro   </h1>    
                        </div>
                    </div>
                </div>
</div>   
