...
<div class="row">
	<div class="col-lg-5">
		<a href="categoria-add.php" class="btn btn-outline btn-primary">Añadir Categoría Principal</a><br>
<br>
			 ...
			 do { 
				...
				<td><?php echo $row_DatosConsulta["idCategoria"];?></td>
					...
					<td><strong><?php echo $row_DatosConsulta["strNombre"];?></strong></td>
						...
						<td></td>
					<td><a href="categoria-edit.php?id=<?php echo $row_DatosConsulta["idCategoria"];?>" class="btn btn-warning btn-circle"><i class="fa fa-edit"></i></a></td>
				</tr>
