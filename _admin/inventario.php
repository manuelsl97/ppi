                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody> 
                                    ...
                                    $query_prod = mysqli_query($con,  "SELECT * FROM productos ") or die(mysqli_error($con));
                                    
                                   while($row=$row_queryprod= mysqli_fetch_array($query_prod) ){
                                      ...
                                      // $insert_hist= mysqli_query($con,  "INSERT INTO historial (id_usuarios,id_productos,cantidad) VALUES ($elu,$procid,1)") or die(mysqli_error($con));
                                        ...
                                        echo'
                                            <tr class="odd gradeX">
                                            <td class="center">'.$row["id_productos"].'</td>
                                            <td>'.$row["p_nombre"].'</td>
                                            <td>'.$row["p_almacen"].'</td>
