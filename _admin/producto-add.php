...
$esprincipal=0;
  ...
  $insertSQL = sprintf("INSERT INTO tblproducto(strNombre, refCategoria1,  refCategoria2,  refCategoria3,  refCategoria4,  refCategoria5,  strImagen1, strImagen2, strImagen3, strImagen4, strImagen5, strDescripcion, dblPrecio, intEstado, refMarca, intPrincipal) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
