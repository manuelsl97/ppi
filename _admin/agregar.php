...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <a href="agregar.php" class="btn btn-outline btn-info">Volver atrás</a><br>
<br>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="agregar2.php" method="post" ><div class="row">
                                <div class="col-lg-6">
                                  
 
                                        <div class="form-group">
                                            <label>Nombre</label>
                                            <input class="form-control" placeholder="Nombre del Producto" name="nombre" id="strNombre">
                                        </div>
                                          <div class="form-group">
                                            <label>Descripción</label>
                                            <textarea name="descripcion" id="strDescripcion">Escribir Descripción</textarea>
                                           
                                        </div>
                                        <div class="form-group">
                                            <label>Foto(previamente  guardada en images</label>
                                            <input class="form-control" placeholder="Nombre de la foto con ext." name="foto" id="strFoto">
                                        </div>
                                          <div class="form-group">
                                            <label>Precio</label>
                                            <input class="form-control" placeholder="Escribir Precio" name="precio" id="dblPrecio">
                                        </div>
                                        <div class="form-group">
